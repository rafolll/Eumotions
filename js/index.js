...
const productsList1 = document.querySelector(".container-items-1");
const productsList2 = document.querySelector(".container-items-2");
const productsList3 = document.querySelector(".container-items-3");
